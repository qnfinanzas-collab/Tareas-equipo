          ...
          <div style={{marginBottom:16, position:"sticky", top:0, zIndex:5}}>
            <HectorPanel
              ...
              negotiations={(negotiations||[])
                ...
                .slice(0, 5)}
              focusTask={focusTask}
              overdueColdCount={overdueColdCount}
              coldNegsCount={coldNegsCount}
              waitingCount={waitingCount}
              onGoMytasks={onGoMytasks}
              onGoDealRoom={onGoDealRoom}
    ...
    <div className="tf-app-root" style={{display:"flex",fontFamily:"'Segoe UI',system-ui,sans-serif",background:"#f9fafb",color:"#111827"}}>
      ...
      <div data-tf="main-content" data-tf-tab={activeTab} style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",minWidth:0}}>
        ...
        <div style={{flex:1,overflow:"auto"}}>
          ...
          {activeTab==="midia"     &&<MiDiaView data={data} activeMember={activeMember} onOpenTask={id=>setOverlayTaskId(id)} onCompleteTask={completeTaskAnywhere} onArchiveTask={archiveTaskAnywhere} onDeleteTask={deleteTaskAnywhere} onUpdateTask={(id,upd)=>updateTaskAnywhere(id,upd)} onMoveTask={moveTaskAnywhere}/>}
