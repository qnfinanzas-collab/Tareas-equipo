  ...
  agents:[
    {
      ...
      advice:{
        ...
        overdue:"Tarea vencida: si hay un plazo legal o contractual detrás, puede haber caducidad o incumplimiento. Notifica por escrito a la otra parte, deja constancia del retraso y evalúa si procede una prórroga formal antes de seguir ejecutando.",
        noDueDate:"Sin fecha límite — peligroso en contexto legal. Fija un deadline contractual explícito y comunícalo por escrito; los compromisos sin fecha se vuelven inejecutables y expiran por caducidad tácita.",
        noSubtasks:"No veo subtareas. En asuntos legales conviene descomponer: revisión documental, redacción, validación interna, firma, archivo. Crea al menos esos hitos para poder auditar el proceso.",
        overBudget:"El tiempo real supera lo estimado. Si es facturable, revisa el pliego de honorarios o el presupuesto cerrado antes de seguir: puede requerir adenda firmada para cobrar el exceso.",
